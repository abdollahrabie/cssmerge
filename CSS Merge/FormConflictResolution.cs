...
namespace CSS_Merge
{
    public partial class FormConflictResolution : Form
    {
        ...
        private void cboSelector_SelectedIndexChanged(object sender, EventArgs eventArgs)
        {
        ...
        private void chklstFiles_SelectedIndexChanged(object sender, EventArgs eventArgs)
        {
            CssConflict conflict = (CssConflict)cboSelector.SelectedItem;
        ...
        private void btnBack_Click(object sender, EventArgs eventArgs)
        {
            if (cboSelector.SelectedIndex > 0)
                cboSelector.SelectedIndex--;
        }
        private void btnNext_Click(object sender, EventArgs eventArgs)
        {
            if (cboSelector.SelectedIndex < cboSelector.Items.Count - 1)
                cboSelector.SelectedIndex++;
        }

        private void btnChooseAll_Click(object sender, EventArgs eventArgs)
        {
